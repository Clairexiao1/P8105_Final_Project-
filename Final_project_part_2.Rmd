...
```
* We can see that in Asia, the most expansive cuisine type is Japanese while cheapest cuisine type is Indian. 
...
```
In Europe, the most expansive cuisine type is Mediterranean which also aligns with our overal plot before stratifying with continents. The cheapest cuisine types in Europe are Thai and Italian, which is really unexpected. 
...
ggplotly(na_plot)
```
* In North America, the most expansive cuisine types are Scandiavian and other_european
