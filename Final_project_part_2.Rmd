...
We have categorized our cuisine types into larger group, like Modern French and French are both categorized into the French Cuisine Type. Now let's take a look at the Number of Restaurants in each Cuisine Type by Michelin Star. 
```{r message=FALSE, warning =FALSE}
...
* We have transformed the price points of each restaurants from a scale of 1-5 previously. 
