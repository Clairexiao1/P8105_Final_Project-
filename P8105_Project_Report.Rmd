...
Cuisine types are recoded into 19 simplified categories according to country and continent, and a new column `cuisine_new` is added to the dataset. `star` was recoded into numeric numbers 1-3 for future analysis. Column `price` is added by converting number of dollar signs to price level. For example, one dollar sign was recoded to 1 for `price`. 
...
Another important topic is finding the best restaurant in the world. 

Cuisine type and Michelin stars:
...
French cuisine type has a relatively high star rating. Michelin star impacts the restaurants' price level: higher star is associated with higher price. 